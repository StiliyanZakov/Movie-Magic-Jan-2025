...
const movieSchema = new Schema({
  title: {
    ...
    match: [
      /^[a-zA-Z 0-9]+$/,
      "Title should be alphanumeric, degits and whitespaces only!",
    ],
  },
  category: {
    type: String,
  ...
  genre: {
    ...
    match: [
      /^[a-zA-Z 0-9]+$/,
      "Genre should be alphanumeric, degits and whitespaces only!",
    ],
  },
  director: {
    type: String,
    ...
    match: [
      /^[a-zA-Z 0-9]+$/,
      "Director should be alphanumeric, degits and whitespaces only!",
    ],
  },
  year: {
    type: Number,
